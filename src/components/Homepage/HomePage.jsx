...
function HomePage() {
  ...
  return (
    <div className='HomePage'>
      ...
      <section className="welcome">
        <div className='Border2'>
          <svg xmlns="http://www.w3.org/2000/svg" width="full" height="1100" viewBox="0 0 1920 1128" fill="none">
      ...
      <section className='Our_Philosophy'>
        ...
        <div className='Border3'>
          <svg xmlns="http://www.w3.org/2000/svg" width="full" height="1100" viewBox="0 0 1920 121" fill="none">
      ...
      <section className='AS_Programs'>
        <div className='Border4'>
          <svg xmlns="http://www.w3.org/2000/svg" width="full" height="1101" viewBox="0 0 1920 1101" fill="#316ADF">
      ...
      <section className='FAQ'>
        <div className='Border5'>
          <svg xmlns="http://www.w3.org/2000/svg" width="full" height="1300" viewBox="0 0 1920 1738" fill="none">
    ...
    //           <div className='PC1'>
    //             <img src="pc1.png" alt="IMG 1" className='IP1'/>
    //             <div className='HC1'><Link to={'/Playgroup'}>PLAYGROUP</Link></div>
    //           </div>
    //           <div className='PC2'>
    //             <img src="pc2.png" alt="IMG 2" className='IP2'/>
    //             <li className='HP2' ><Link to={'/PreNursery'}>PRE-NURSERY</Link></li>
    //           </div>
    //           <div className='PC3'>
    //             <img src="pc3.png" alt="IMG 3" className='IP3'/>
    //             <li className='HP3' >NURSERY</li>
    //           </div>
    //           <div className='PC4'>
    //             <img src="pc4.png" alt="IMG 4" className='IP4'/>
    //             <li className='HP4' ><a href='../OurPrograms/Playgroup'>KINDERGARTEN</a></li>
    //           </div>
    //         </section>
    //         <section className='AS_Programs'>
    ...
    //         <section className='Testimonials'>
    //           <div className='Lines'>
    //             <img src="Group.png" alt="Image 1" className='Line'/>
    //                 </div>
    //                </section>
    //              <section className='FAQ'>
    //           <div className='Border5'>
